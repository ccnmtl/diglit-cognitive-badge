...
5.  Edit the repository content.
    ...
    a.  Tip 1: The recommended workflow is to create a branch from the `master` branch and make edits in that branch. Once you have made your edits, create a pull request. A peer can then review changes and merge your changes with the Master.
